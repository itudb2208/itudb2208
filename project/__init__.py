...
BLUEPRINT_NAMES = ['about','login','teams','players','coaches','query','player','coach','team','home']  # Names of the blueprints (sub-applications) that will be registered by the main application
